COURSE_ACTS(COURSE_BOB, _(" 1 MUSHROOM HILLS"),
       _("ANGRY KING ON THE HIGH CASTLE")     , _("SECRET ON THE HIGH PLATFORM") , _("RED COINS ON THE HILLS"),
       _("STAR INSIDE THE HIGH HILL")          , _("STAR BEHIND THE SECRET BOX")        , _("HIDDEN PIPE UNDER THE HILL"))
