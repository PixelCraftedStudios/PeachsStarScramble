...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		MARIO_POS(0x01, 0, -2776, 862, 39),
		OBJECT(MODEL_NONE, 15665, 4622, -8652, -21, 106, -4, 0x00000000, bhvRGBLight),
		OBJECT(MODEL_NONE, -2776, 862, 39, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
