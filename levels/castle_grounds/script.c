...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(2, castle_grounds_area_2),
		...
		OBJECT(MODEL__1STARBARRIER, 1643, 320, -1478, 0, 0, 0, 0x00000000, bhv1StarBarrier),
		OBJECT(MODEL__1STARBARRIER, 919, 320, -2441, 0, 69, 0, 0x00000000, bhv1StarBarrier),
		OBJECT(MODEL_BOBOMB_BUDDY, -3174, -540, 1201, 0, 140, 0, (0x02 << 16), bhvBobombBuddy),
		OBJECT(MODEL_NEWPIPE, 2004, 0, -1612, 0, 0, 0, (0x0D << 16), bhvWarpPipe),
		OBJECT(MODEL_NEWPIPE, -3817, -618, 1223, 0, 0, 0, (0x0B << 16), bhvWarpPipe),
		MARIO_POS(0x02, 1, -510, 416, -2617),
		OBJECT(MODEL_NONE, -368, 105, -1975, 0, 1, 0, (0x0C << 16), bhvAirborneStarCollectWarp),
