...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		MARIO_POS(0x01, 0, -961, 190, 2596),
		OBJECT(MODEL_STAR, -593, 678, -1127, 0, 0, 0, (0 << 16), bhvStar),
		OBJECT(MODEL_NONE, -961, 190, 2596, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
		TERRAIN(wf_area_1_collision),
		MACRO_OBJECTS(wf_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_SHELLSHORE),
