...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		MARIO_POS(0x01, 0, -1944, 55, 288),
		OBJECT(MODEL_NONE, -1944, 55, 288, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_THI_WARP_PIPE, -2686, 0, 1204, 0, 0, 0, (0x02 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -2091, -7, 1202, 0, 0, 0, (0x01 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -1491, -7, 1193, 0, 0, 0, (0x03 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -898, -36, 1193, 0, 0, 0, (0x04 << 16), bhvWarpPipe),
		...
		SET_BACKGROUND_MUSIC(0x00, SEQ_SELECT),
