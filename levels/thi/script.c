...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		MARIO_POS(0x01, -66, 1138, 55, -417),
		OBJECT(MODEL_NONE, 1138, 55, -417, 0, -66, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_THI_WARP_PIPE, 0, -25, -1, 0, 0, 0, (0x02 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 1649, -34, -1499, 0, 0, 0, (0x01 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 4045, -25, 1323, 0, 0, 0, (0x03 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 2302, -25, 1324, 0, 0, 0, (0x04 << 16), bhvWarpPipe),
