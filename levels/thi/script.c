...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		MARIO_POS(0x01, 0, 0, -41, -294),
		OBJECT(MODEL_NONE, 0, -41, -294, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_THI_WARP_PIPE, -1810, -119, -1627, 0, 0, 0, (0x02 << 16), bhvWarpPipe),
