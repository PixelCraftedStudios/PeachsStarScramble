...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		MARIO_POS(0x01, 0, 0, 55, -294),
		OBJECT(MODEL_NONE, 0, 55, -294, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_THI_WARP_PIPE, 0, -34, -1, 0, 0, 0, (0x02 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 3747, -34, -1499, 0, 0, 0, (0x01 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 4045, -25, 1323, 0, 0, 0, (0x03 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 4400, -25, 1324, 0, 0, 0, (0x04 << 16), bhvWarpPipe),
