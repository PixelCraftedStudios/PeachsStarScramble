...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		MARIO_POS(0x01, 169, -4111, 397, 7307),
		OBJECT(MODEL_STAR, 351, 11399, -78, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, -4111, 397, 7307, 0, 169, 0, (0x0A << 16), bhvSpinAirborneWarp),
