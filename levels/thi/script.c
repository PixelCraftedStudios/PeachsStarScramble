...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		MARIO_POS(0x01, 0, 583, 55, -1010),
		OBJECT(MODEL_NONE, 583, 55, -1010, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_THI_WARP_PIPE, 633, -25, 1321, 0, 0, 0, (0x02 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -539, -25, 1318, 0, 0, 0, (0x01 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 45, -25, 1323, 0, 0, 0, (0x03 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 340, -25, 1326, 0, 0, 0, (0x04 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -248, -25, 1318, 0, 0, 0, (0x05 << 16), bhvWarpPipe),
