...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		MARIO_POS(0x01, 180, -9433, 167, 6070),
		...
		OBJECT_WITH_ACTS(MODEL_STAR, -5176, 4015, -3879, 0, 0, 0, 0x01000000, bhvStar, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT(MODEL_BOUNCINGSHROOM, -2040, 1654, -6282, 0, 0, 0, 0x00000000, bhvbouncingShroom),
