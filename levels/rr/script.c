...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		MARIO_POS(0x01, -125, 3640, -328, 1117),
		OBJECT(MODEL_PIRANHAALT, 126, -106, -1081, 0, 0, 0, 0x00000000, bhvPiranhaPlant),
		OBJECT(MODEL_NONE, 3640, -328, 1117, 0, -125, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_SILVERSTAR, 865, -283, -3483, 0, 0, 0, 0x00000000, bhvSilverStar),
		OBJECT(MODEL_SILVERSTAR, -841, 909, -2384, 0, 0, 0, 0x00000000, bhvSilverStar),
		OBJECT(MODEL_SILVERSTAR, -2908, 543, -3390, 0, 0, 0, 0x00000000, bhvSilverStar),
		OBJECT(MODEL_SILVERSTAR, -970, -286, -2640, 0, 0, 0, 0x00000000, bhvSilverStar),
		OBJECT(MODEL_SILVERSTAR, -3117, -4, 2517, 0, 0, 0, 0x00000000, bhvSilverStar),
		OBJECT(MODEL_SSL_PALM_TREE, -2908, -46, -3386, 0, 0, 0, 0x00000000, bhvTree),
